...
using JHipsterDotNetCore6.Security;
using JHipsterDotNetCore6.Security.Jwt;
using JHipsterDotNetCore6.Domain.Services;
using JHipsterDotNetCore6.Domain.Services.Interfaces;
...
using AuthenticationService = JHipsterDotNetCore6.Domain.Services.AuthenticationService;
using IAuthenticationService = JHipsterDotNetCore6.Domain.Services.Interfaces.IAuthenticationService;
